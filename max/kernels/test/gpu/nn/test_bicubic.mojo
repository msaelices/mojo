...
fn test_bicubic_kernel[
    ...
    resize_bicubic[dtype, target="cpu"](output_tensor, input_tensor, ctx)
    print(
    ...
    resize_bicubic[dtype, target="gpu"](
        output_dev_tensor, input_dev_tensor, ctx
    )
...
fn test_large_image_gpu_launch[dtype: DType](ctx: DeviceContext) raises:
    ...
    alias kernel = gpu_bicubic_kernel[
        dtype, layout_4d, output_dev_tensor.address_space
    ]
